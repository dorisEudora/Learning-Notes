...
在React的开发模式中，通常情况下**不需要、也不建议直接操作DOM原生**，但是某些特殊的情况，确实需要获取到DOM进行某些操作：
...
![图片](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==)class组件案例
...
![image-20211007110231315](C:\Users\l\AppData\Roaming\Typora\typora-user-images\image-20211007110231315.png)
