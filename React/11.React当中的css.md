...
- 通过是否添加 `scoped` 属性来决定编写的样式是**全局有效还是局部有效**；
...
![image-20211009200004096](C:\Users\l\AppData\Roaming\Typora\typora-user-images\image-20211009200004096.png)



这种css使用方式最终生成的class名称会全局唯一：

![image-20211009200023110](C:\Users\l\AppData\Roaming\Typora\typora-user-images\image-20211009200023110.png)
...
![图片](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==)styled-components基本使用
...
export class CssInReactComp extends PureComponent {
    constructor(props) {
        super(props)
        this.state = {
            list: [
...
![image-20211009202717678](C:\Users\l\AppData\Roaming\Typora\typora-user-images\image-20211009202717678.png)
...
React当中设置class不再是class关键词，而是className